...
use crate::{
    registry::{AgreementRegistry, BlocklistRegistry, IndexingAgreementStatus},
...
/// - Which indexers are on the blocklist and should be excluded entirely
...
where
    R: AgreementRegistry + BlocklistRegistry,
{
    ...
    // Get blocklisted indexers that should be excluded from selection
